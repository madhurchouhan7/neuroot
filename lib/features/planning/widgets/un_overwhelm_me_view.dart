...
class UnOverwhelmMeView extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildMicrotaskCard('Open the project PDF and read the first page'),
              const SizedBox(height: 10),
              _buildMicrotaskCard('Create a folder named OS_Project'),
              const SizedBox(height: 10),
              _buildMicrotaskCard('Find 2 reference papers'),
              const SizedBox(height: 10),
              _buildMicrotaskCard('Write down the 3 main requirements'),
